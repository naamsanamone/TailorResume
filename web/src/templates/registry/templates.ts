...
export const TEMPLATE_REGISTRY: Record<string, TemplateRegistryEntry> = {
  ...
  'swiss-two-column': {
    ...
    loadComponent: () => import('@/templates/swiss-two-column/SwissTwoColumnTemplate'),
  },
  ...
  'rm-modern': {
    ...
    loadComponent: () => import('@/templates/rm-modern/RmModernTemplate'),
  },

  'rm-modern-two-col': {
    id: 'rm-modern-two-col',
    name: 'RM Modern 2-Col',
    thumbnail: '/templates/modern.png',
    sectionLayout: {
      regionKeys: [REGION_IDS.main, REGION_IDS.sidebar],
      defaults: {
    ...
    loadComponent: () => import('@/templates/rm-modern-two-col/RmModernTwoColTemplate'),
  },
  ...
  vivid: {
    ...
    loadComponent: () => import('@/templates/vivid/VividTemplate'),
  },
};
